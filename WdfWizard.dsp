# Microsoft Developer Studio Project File - Name="WdfWizard" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Dynamic-Link Library" 0x0102

CFG=WdfWizard - Win32 Pseudo-Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "WdfWizard.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "WdfWizard.mak" CFG="WdfWizard - Win32 Pseudo-Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "WdfWizard - Win32 Release" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "WdfWizard - Win32 Pseudo-Debug" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE 
...
!IF  "$(CFG)" == "WdfWizard - Win32 Release"
...
OutDir=.\Release
TargetPath=.\Release\WdfWizard.awx
TargetName=WdfWizard
InputPath=.\Release\WdfWizard.awx
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "WdfWizard - Win32 Pseudo-Debug"
...
# Begin Custom Build - Copying custom AppWizard to Template directory...
OutDir=.\Debug
TargetPath=.\Debug\WdfWizard.awx
TargetName=WdfWizard
InputPath=.\Debug\WdfWizard.awx
SOURCE="$(InputPath)"

"$(MSDEVDIR)\Template\$(TargetName).awx" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	if not exist "$(MSDEVDIR)\Template\nul" md "$(MSDEVDIR)\Template" 
	copy /Y "$(TargetPath)" "$(MSDEVDIR)\Template" 
	if exist "$(OutDir)\$(TargetName).pdb" copy "$(OutDir)\$(TargetName).pdb" "$(MSDEVDIR)\Template" 
...
# Name "WdfWizard - Win32 Release"
# Name "WdfWizard - Win32 Pseudo-Debug"
...
SOURCE=.\StepOneDlg.cpp
# End Source File
# Begin Source File

SOURCE=.\WdfWizard.cpp
# End Source File
# Begin Source File
